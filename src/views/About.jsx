      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <motion.div
              variants={item}
              className="w-full lg:w-2/5 flex justify-center relative mr-12"
              style={{ zIndex: 2 }}
            >
              <div className="relative">
                {/* Profile image */}
                <div className="relative rounded-full overflow-hidden w-96 h-96 border-4 border-white shadow-2xl ">
                  <motion.div 
                ...
                >
                  {techStack.map((tech, index) => (
                    <motion.div
                      ...
                      className="absolute"
                      style={{
                        transform: `rotate(${index * (360 / techStack.length)}deg) translateX(240px)`,
                      }}
                      whileHover={{
                        scale: 1.5,
                        zIndex: 10,
